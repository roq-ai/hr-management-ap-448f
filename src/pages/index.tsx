  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management Application: Your ultimate solution for streamlined human resources operations, enhancing productivity and fostering a positive work environment."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1559659160-10066d7433e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxodW1hbiUyQnJlc291cmNlc3xlbnwwfHx8fDE2OTgyMjM0MTZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management Application: Your ultimate solution for streamlined human resources operations, enhancing productivity and fostering a positive work environment.`}
            </Text>
            <Box
