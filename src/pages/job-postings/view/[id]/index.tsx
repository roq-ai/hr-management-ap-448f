...
import { useJobPostingFindFirst, useRoqClient } from 'lib/roq';
...
function JobPostingViewPage() {
  ...
  const { data, error, isLoading } = useJobPostingFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('job_posting', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/job-postings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Posted At" text={data?.posted_at ? format(data?.posted_at, 'dd-MM-yyyy') : ''} />
